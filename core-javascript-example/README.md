...
Running directly via file paths (file://) can block features like JavaScript modules (import/export) due to browser CORS policies. Using a lightweight server avoids this issue.
